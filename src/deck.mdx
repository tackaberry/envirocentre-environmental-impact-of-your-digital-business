...
- Reducing the payload (what you're downloading)
- Reducing the constant flow of data as you interact with the site.
...
# Its all about making the payload smaller
...
- Quebec electricity boasts 99% renewble energy (eg hydro)
...
### Lots of harmful chemicals from electronics seep into water and soil
...
### Digital Climate Strike 2019 - Comapnies shut down online stores
...
2. Lower your monitor brightness - 100% to 70% can save 20%

3. Adjust power settings - sleep hibernate

4. Remeber anti-tracking software?

5. Use Ecosia as a search engine.

- Funds tree planting from the profit it makes through online searches
