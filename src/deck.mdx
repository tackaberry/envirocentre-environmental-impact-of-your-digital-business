...
import Img08a from "./images/08a.png";
...
### Gatsby uses GraphQL to combine your data and your React code to generate static files.
...
#### _ ...(the frontend part of) a JAMstack application (JavaScript, API, Markup)_

---

## Why Gatsby is popular and growing

<Box style={{width:'80%'}}>

- the popularity of the JAMstack approach to building Web Apps and Web Sites
- the rapid adoption of the Progressive Web Apps technology in the industry
  - ☝ _which is one of the key features of Gatsby_
- it’s built in React and GraphQL
- it’s really powerful
- it’s fast
- the documentation is great
- it hides the complexity, with hooks to customize

<Box style={{fontSize:"1rem", fontStyle:"italic"}}>

adapted from: https://flaviocopes.com/gatsby/
...
# Gatsby ➾ Server Side Rendered React
...
<Image src={Img08a} style={{ height: "800px", width: "1200px" }} />
...
- API
- Database
- The file system itself - json or md or mdx content files
...
- Github Push + Github Actions ➾ Deploy to AWS
- See (`.github/workflows/main.yml`)
- Deploys to: http://algonquin-iawd-trends-web-development.s3-website.ca-central-1.amazonaws.com/
- A new point
